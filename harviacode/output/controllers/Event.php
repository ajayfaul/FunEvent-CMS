...
class Event extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => '{namamodule}/event/event_list',
    ...
    public function create(){
      $data = array(
        'contain_view' => '{namamodule}/event/event_form',
        ...
        'action'=>'{namamodule}/event/create_action',
        'module'=>'{namamodule}',
        'titlePage'=>'event',
        'controller'=>'event'
       );
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => '{namamodule}/event/event_edit',
        'sidebar'=>'{namamodule}/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'{namamodule}/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'{namamodule}/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'{namamodule}/event/update_action',
        'dataedit'=>$dataedit,
        'module'=>'{namamodule}',
        'titlePage'=>'event',
        'controller'=>'event'
    ...
    public function create_action()
    {
		...
		'gambar' => $this->input->post('gambar',TRUE),
            ...
            redirect(site_url('{namamodule}/event'));
        }
    }
